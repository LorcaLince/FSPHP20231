<?php include("menu.php") ;?>
    ...
    <main>
        <div id="ba1" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="texto">
            <h4>Bs As llega por primera vez a Argentina.Un evento para compartir con nuestra comunidad el conocimiento y
                experiencia de los expertos que estan creando el futuro del internet. Ven a conocer miembros del evento,
                a otros estudiantes de Codo a Codo y los oradores de primer nivel que tenemos parati.Te esperamos!</h4>
        </div>
        <br>

        <div class="buttons">
            <button type="button" class="btn btn-outline-light btn-lg" onclick="location.href='#convierteteenorador'">Quiero ser orador</button>
            <button type="button" class="btn btn-success btn-lg" onclick="location.href='HTML/ticket.html'"><a id="ticket">Comprar tickets</a></button>
        </div>
            ...
            <div class="card1">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-info"
                        style="background-color: lightseagreen; color: white; font-weight: 750; padding: 3px; font-size: 12px; padding-top: 1px; padding-bottom: 1px;">React</button>
                    <h5 class="card-title">Steve Jobs</h5>
                    <p class="card-text" style="font-size: 15.5px; line-height: 25px; ">
                        Itaque ullam deleniti quia nam modi omnis explicabo nulla voluptatibus, autem nisi impedit?
                        Inventore a vel mollitia ut temporibus cumque, consequuntur blanditiis dicta maxime quia hic
                        aspernatur, ullam voluptas autem?</p>
                </div>
            </div>
            <div class="card2">
        ...
        <br>
                <div class="container" style="margin: 0%; padding: 0%">
                    <div class="col-6 themed-grid-col" >
                        <div class="container" style="margin: 0%; padding: 0%">
                            ...
                            <div id="ba2" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner ">
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="./imagenes/honolulu.jpg" alt="First slide" style="width: 100%">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="./imagenes/hawaii.jpg" alt="Second slide" style="width: 100%">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="./imagenes/hawaii2.jpg" alt="Third slide" style="width: 100%">
                                    </div>
                                </div>
                                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleAutoplaying"
                                    data-bs-slide="prev">
            ...
            <div class="col-6 themed-grid-col text">
                <h1><a id="bsasoctubre"></a></h1>
                <h1 class="bsasoctubre">Bs As - Octubre</h1>
                <p class="bsastexto">Buenos Aires es la provincia y localidad más grande del estado de Argentina, en
                    los Estados Unidos. Honolulu es la más sureña de entre las principales ciudades
                    estadounideneses.Aunque el nonmbre de Honolulu se refiere al área urbana en la costa sureste de la
                    isla de Oahu, la ciudad y el condado de Honolulu han formado una ciudad condado consolidada que
                    cubre toda la ciudad(aproximadamanete d600km de superficie)</p>
                <br>
